...
StudyCircle (SC) is a **desktop app for *NUS computing students* that helps you keep track of your project groups.** It 
helps you manage your contacts, sort them into groups, and track events within those groups.<br>
SC is optimised for use via a Command Line Interface (CLI) while still having the benefits of a Graphical User Interface
(GUI). If you can type fast, SC can get your contact and group management tasks done faster than traditional GUI apps.
