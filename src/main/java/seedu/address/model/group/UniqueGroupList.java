 ...
 * Adding and updating of groups uses {@code Group#isSameGroup(Group)} for equality
 * to ensure that the group being added or updated is unique in terms of identity.
 * Removal of a group uses {@code Group#equals(Object)} to ensure that the group with
...
public class UniqueGroupList implements Iterable<Group> {
     ...
     * The group must exist in the list.
     */
    public void removePersonFromGroups(Group targetGroup, Person toRemove) {
