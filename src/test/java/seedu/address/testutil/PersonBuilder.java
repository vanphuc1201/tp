...
public class PersonBuilder {
    ...
    public static final String DEFAULT_EMAIL = "e0000000@u.nus.edu";
    ...
    /**
     * Parses the {@code groups} into a {@code Set<GroupName>} and set it to the {@code Person} that we are building.
     */
